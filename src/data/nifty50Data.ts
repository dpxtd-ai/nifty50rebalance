...
export const UPCOMING_INCLUSIONS: UpcomingInclusionStock[] = [
  ...
  },
  {
    ...
    sector: 'Defence / Naval Shipbuilding',
    currentRankInEligibleUniverse: 6,
    projectedNifty50WeightPercent: 0.58,
    estimatedPassiveInflowCr: 1480,
    estimatedPassiveInflowUsdM: 178,
    daysToCoverInflow: 3.4,
    expectedInclusionDate: 'Upcoming Review Cycle (Next 1 Month)',
    timeHorizon: 'Next 1 Month',
    criteriaStatus: {
      freeFloatCutoffMet: true,
    ...
    alphaRationale: '+52.4% annualized alpha driven by sovereign naval defence capex upcycle and multi-year order backlog execution.',
    growthDriver: 'Indigenous aircraft carrier (IAC-2) refits, next-generation corvette deliveries, and commercial green vessel export pipeline.',
    tradeTiming: {
      action: 'BUY_NOW',
      actionHeadline: 'RIGHT TIME TO BUY NOW - Defence Supercycle Wave',
      holdTillPrice: 1580.0,
      currentEntryRange: '₹1,350 - ₹1,375',
      stopLossPrice: 1240.0,
      timingAdvice: 'Optimal buying zone active. Defence order book visibility shields earnings from cyclical headwinds. Hold till target ₹1,580.00.',
      catalystWindow: 'Hold till Semi-Annual Index Review settlement'
    },
    metrics: {
      currentPrice: 1367.00,
      dailyChangePercent: -0.22,
      marketCapCr: 71900,
      freeFloatMCapCr: 48500,
      sixMonthAvgFreeFloatCr: 44200,
      sixMonthAvgDailyTurnoverCr: 512,
      impactCostPercent: 0.11,
      alphaPercent: 52.4,
      beta: 1.28,
  ...
  },
  {
    ...
    sector: 'Metals & Mining / Aluminium',
    currentRankInEligibleUniverse: 7,
    projectedNifty50WeightPercent: 0.52,
    estimatedPassiveInflowCr: 1340,
    estimatedPassiveInflowUsdM: 161,
    daysToCoverInflow: 3.1,
    expectedInclusionDate: 'Upcoming Review Cycle (Next 1 Month)',
    timeHorizon: 'Next 1 Month',
    criteriaStatus: {
      freeFloatCutoffMet: true,
    ...
    alphaRationale: '+34.8% alpha powered by elevated alumina prices on London Metal Exchange and lowest-quartile captive bauxite cost.',
    growthDriver: 'Utkal D and E coal block operationalization, brownfield smelter expansion, high dividend yield cushion.',
    tradeTiming: {
      action: 'BUY_NOW',
      actionHeadline: 'RIGHT TIME TO BUY NOW - Multi-Year Alumina Margin Expansion',
      holdTillPrice: 395.0,
      currentEntryRange: '₹350 - ₹360',
      stopLossPrice: 325.0,
      timingAdvice: 'Accumulate at current market price. Robust global commodity prices and cash-rich balance sheet support steady inclusion trajectory. Target ₹395.00.',
      catalystWindow: 'Hold till Upcoming Review settlement'
    },
    metrics: {
      currentPrice: 357.60,
      dailyChangePercent: -0.22,
      marketCapCr: 65700,
      freeFloatMCapCr: 45200,
      sixMonthAvgFreeFloatCr: 41800,
      sixMonthAvgDailyTurnoverCr: 480,
  ...
  },
  {
    ...
    currentRankInEligibleUniverse: 8,
    projectedNifty50WeightPercent: 0.49,
    estimatedPassiveInflowCr: 1260,
    estimatedPassiveInflowUsdM: 151,
    daysToCoverInflow: 3.2,
    expectedInclusionDate: 'Next 1 Month (Contender Reserve)',
    timeHorizon: 'Next 1 Month',
    criteriaStatus: {
      freeFloatCutoffMet: true,
      foEligible: true,
    ...
    alphaRationale: '+48.2% alpha with sovereign mandate for Project 75I stealth submarines and Project 17A guided-missile stealth frigates.',
    growthDriver: '₹38,000+ Cr order book execution, high return on equity (>32%), expanding international naval repair mandates.',
    tradeTiming: {
      action: 'BUY_NOW',
      actionHeadline: 'RIGHT TIME TO BUY NOW - Submarine Execution Wave',
      holdTillPrice: 2450.0,
      currentEntryRange: '₹2,170 - ₹2,210',
      stopLossPrice: 1980.0,
      timingAdvice: 'Buy now in entry zone ₹2,170 - ₹2,210. High institutional backing and multi-year submarine order book make this a premier alpha compounder. Target ₹2,450.00.',
      catalystWindow: 'Hold till Semi-Annual Review implementation'
    },
    metrics: {
  ...
  },
  {
    ...
    currentRankInEligibleUniverse: 9,
    projectedNifty50WeightPercent: 0.46,
    estimatedPassiveInflowCr: 1190,
    estimatedPassiveInflowUsdM: 143,
    daysToCoverInflow: 2.9,
    expectedInclusionDate: 'Next 1 Month (Contender Reserve)',
    timeHorizon: 'Next 1 Month',
    criteriaStatus: {
      freeFloatCutoffMet: true,
    ...
    alphaRationale: '+36.5% alpha backed by radar, electronic warfare systems, and avionics supply monopoly for Indian armed forces.',
    growthDriver: 'Unprecedented domestic defense spending, export growth to friendly foreign nations, high operating margins.',
    tradeTiming: {
      action: 'HOLD_TILL_PRICE',
      actionHeadline: 'HOLD TILL TARGET ₹440 - Defence Avionics Monopoly',
      holdTillPrice: 440.0,
      currentEntryRange: '₹390 - ₹396',
      stopLossPrice: 360.0,
      timingAdvice: 'Hold existing positions till target ₹440. Low volatility, consistent margin execution, and debt-free balance sheet make this an anchor institutional holding.',
      catalystWindow: 'Hold till Next 1 Month review window'
    },
    metrics: {
      currentPrice: 393.30,
      ...
      marketCapCr: 287400,
      freeFloatMCapCr: 48600,
      sixMonthAvgFreeFloatCr: 45800,
      sixMonthAvgDailyTurnoverCr: 590,
      impactCostPercent: 0.08,
      alphaPercent: 36.5,
      beta: 0.95,
